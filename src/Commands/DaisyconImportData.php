...
//
//                        $url = $feed->{
//                        	        "feed_link_" . strtolower(Config::get('daisycon.feed_type', 'csv'))
//                                } .
						$url =  'https://daisycon.io/datafeed/' .
						        '?filter_id=' . Config::get('daisycon.filter_id') .
						        '&media_id=144305' .
//								'&standard_id=16' .
                                '&settings_id=' . Config::get('daisycon.settings_id') .
                                '&language_code=nl' .
                                '&locale_id=1' .
						        '&encoding=' . Config::get("daisycon.encoding") .
						        '&general=true' .
